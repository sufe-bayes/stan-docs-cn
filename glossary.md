...
| 章节 | 英文术语 | 中文翻译 |
|------|---------|---------|
| **基础术语** | thin QR decomposition | 薄 QR 分解 |
...
| **1.5 Logistic 回归和 Probit 回归** | link function | 链接函数 |
| | Logit Parameterization | Logit 参数化 |
| **1.9 分层回归** | pooling | 汇集 |
| **1.13 分层模型的多元先验** | group-level coefficients | 组级系数 |
| | scale vector | 尺度向量 |
| **3. 缺失数据和部分已知参数** | | |
| **3.5 缺失的多变量数据** | dummy values | 虚拟值 |
| **5. 有限混合模型** | modes | 峰值 |
| **11. 方向、旋转和超球面** | | |
| **11.1 单位向量** | compact | 紧致的 |
| | improper | 不正确的 |
| **11.2 圆、球体和超球体** | a set of points | 一组点 |
